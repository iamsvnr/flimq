...
export default function MovieDetailPage() {
  ...
  const { user } = useAuth();
  const { rating: userRating, setUserRating, avgRating: communityRating, totalRatings, allRatings } = useUserRating(Number(id), 'movie');
  ...
  return (
    <motion.div variants={pageVariants} initial="initial" animate="animate" exit="exit" className="bg-[#0a0a0a]">
      ...
      <div className="relative z-10 -mt-72 md:-mt-80 px-4 md:px-10 max-w-[1400px] mx-auto pb-16">
        ...
        {/* Reviews */}
        <ReviewSection reviews={reviews} tmdbId={Number(id)} mediaType="movie" />

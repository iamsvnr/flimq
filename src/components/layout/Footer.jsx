    ...
    <footer className="mt-auto bg-[#0a0a0a]">
      <div className="max-w-[1400px] mx-auto px-4 md:px-10 py-10">
        ...
        <div className="flex flex-wrap gap-x-8 gap-y-2 mb-8">
          <Link to="/movies" className="text-[12px] text-white/25 hover:text-white/50 transition-colors">Movies</Link>
          <Link to="/tv-shows" className="text-[12px] text-white/25 hover:text-white/50 transition-colors">TV Shows</Link>
          <Link to="/my-list" className="text-[12px] text-white/25 hover:text-white/50 transition-colors">Watchlist</Link>
        </div>
